			...
			var th=$(this),				
				_=th.data('_TMS')||{
					presets:{
						...
						random:{prsts:['centralExpand','zoomer','fadeThree','simpleFade','gSlider','vSlider','slideFromLeft','slideFromTop','diagonalFade','diagonalExpand','fadeFromCenter','lines','verticalLines','horizontalLines']}
					},
					ways: {				
						lines: function () {
							var opt=this
